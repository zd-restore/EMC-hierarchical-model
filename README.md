...
##### *The dataset used for the single lumped Bayesian model is provided in lumped_model_data.csv. EMC values are provided on the natural-log scale, and the four predictors are provided as standardized z-scores.
